...
(function(global) {
...
})(this), define("../vendor/requirejs/require", function() {}), ! function(e, t) {
    ...
    function(e, t) {
        ...
        return t
    }), define("models/Locale", ["backbone"], function(e) {
    var t = e.Model.extend({
        ...
        initialize: function(e) {
            e != null && e != undefined ? this.set("code", e) : this.set("code", "en-US"), this.setUrl()
        },
        setUrl: function() {
            this.url = "locales/" + this.get("code") + ".json"
        },
        parse: function(e) {
            this.set("data", e);
            return
    ...
    return t
}), define("utils/LocalizationHelper", ["models/Locale"], function(e) {
    var t = function() {
        function t() {}
        return t.prototype.currentLocale = null, t.prototype.router = null, t.prototype.$window = null, t.prototype.changeLocale = function(t, n, r) {
            if (this.currentLocale != null && this.currentLocale.get("code") == t) return;
            var i = this,
                s = new e(t);
            s.fetch().success(function() {
                i.currentLocale = s, typeof n != "undefined" && n && window.vent.trigger("Locale:change", i.currentLocale), typeof r != "undefined" && r()
            }).error(function() {
                console.log("an error occurred fetching the requested locale: " + t)
            })
        }, t.prototype.getInitialLocale = function(e) {
            var t = "en-US";
            if (window.location.hash) {
                var n = window.location.hash;
                n = n.replace("#", ""), n.substring(0, 1) == "/" && (n = n.substring(1));
                var r = n.split("/"),
                    i = r[0];
                switch (i) {
                    case "intro":
            ...
            this.changeLocale(t, !1, e)
        }, t.prototype.getNode = function(e) {
            if (this.currentLocale == null) throw new Error("Error: the current locale is not set.");
            var t = this.currentLocale.get("data"),
                n = t,
                r = e.split(".");
            for (var i = 0; i < r.length; i++) {
                var s = r[i];
                if (typeof n[s] == "undefined") return null;
                n = n[s];
    ...
    return new t
}), define("utils/BrowserHelper", ["backbone"], function(e) {
    var t = e.View.extend({
        initialize: function() {
            window.mobile = this.detectMobile()
        },
        detectMobile: function() {
            var e = navigator.userAgent.match(/Android/i),
                t = navigator.userAgent.match(/BlackBerry/i),
                n = navigator.userAgent.match(/iPhone|iPod/i),
                r = navigator.userAgent.match(/Opera Mini/i),
                i = navigator.userAgent.match(/IEMobile/i);
            return e || t || n || r || i
        }
    });
    return new t
}), define("App", ["backbone", "utils/LocalizationHelper", "utils/BrowserHelper"], function(e, t, n) {
    var r = function() {
        function n() {
            window.vent = _.extend({}, e.Events), this.initEvents()
        }
        return n.prototype.router = null, n.prototype.$window = null, n.prototype.vent = null, n.prototype.initEvents = function() {
            this.$window = $(window), this.$window.on("resize", _.bind(this.onResize, this)), this.$window.on("orientationchange", _.bind(this.onOrientationChange, this)), $(document).on("click", "a[target='_blank']", _.bind(this.processExternalLink, this)), $(document).on("click", "a[href^='/']", _.bind(this.processGenericClick, this))
        }, n.prototype.onResize = function() {
            window.vent.trigger("App:onResize", {
                width: this.$window.width(),
                height: this.$window.height()
            })
        }, n.prototype.onOrientationChange = function() {
            window.vent.trigger("App:onOrientationChange")
        }, n.prototype.navigateTo = function(e) {
            var n = t.currentLocale.get("code");
            n === "en-US" ? e = "#" + e : e = "#/" + n + e, this.router.navigate(e, {
                trigger: !0
            })
        }, n.prototype.processExternalLink = function(e) {
            var t = $(e.currentTarget).attr("href");
            this.trackEvent("externalLinkClicked", t);
            if ($(e.currentTarget).is(".no-coppa")) return;
            e.preventDefault(), this.router.exitView.linkURL = t, this.router.navigate("exit", !0)
        }, n.prototype.processGenericClick = function(e) {
            var n = $(e.currentTarget),
                r = n.attr("href"),
                i = !1;
            n.hasClass("routerBypass") && (i = !0);
            if (!i && !e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey) {
                var s = t.currentLocale.get("code");
                return s === "en-US" ? r = "#" + r : r = "#/" + s + r, e.preventDefault(), this.router.navigate(r, !0)
            }
        }, n.prototype.start = function(n) {
            var r = this;
            this.router = n, t.getInitialLocale(function() {
                window.vent.trigger("Locale:initialSet"), e.history.start(), r.router.hasInitted = !0
            }), window.vent.on("PageChange", function(e) {
            ...
            typeof n == "undefined" ? ga("send", "event", e, t, "", 1) : ga("send", "event", e, t, n, 1)
        }, n
    }();
    return new r
}), require(["App"], function(e) {
    require(["AppRouter"], function(t) {
        e.start(t)
    })
}), define("prod-boot", function() {}), define("views/index/LanguageSelectorView", ["App", "backbone"], function(e, t) {
    var n = t.View.extend({
        currHeight: 0,
        el: "#language-selector",
        events: {
            click: "onSelectorToggle",
            "click li": "onItemClick"
        },
        initialize: function() {
            this.initHTML(), this.render()
        },
        initHTML: function() {
            this.select = $("#index select"), this.currHeight = this.$el.height()
        },
        render: function() {
            var e = this,
                t = "";
            _.each(this.select.find("option"), function(e) {
                t += "<li data-value=" + $(e).val() + ">" + $(e).html() + "</li>"
            }), this.$el.html(t)
        },
        onSelectorToggle: function() {
            this.$el.is(".close") ? ($(window).width() < 960 ? this.$el.css({
                height: 22 * this.$el.find("li").length + 6
            }) : this.$el.css({
                height: 30 * this.$el.find("li").length + 12
            }), this.$el.removeClass("close")) : ($(window).width() < 960 ? this.$el.css({
                height: 27
            }) : this.$el.css({
                height: 40
        ...
        onItemClick: function(t) {
            if ($(t.currentTarget).index() == 0) return;
            this.$el.prepend($(t.currentTarget)), e.router.navigate("#/" + $(t.currentTarget).data("value"), {
                trigger: !0
            })
        },
        update: function(e) {
            this.$el.prepend(this.$el.find("li").eq(e))
        }
    });
    return n
}), ! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("handlebars", t) : "object" == typeof exports ? exports.Handlebars = t() : e.Handlebars = t()
}(this, function() {
    return function(e) {
        function t(r) {
        ...
        function r() {
            ...
            }, e.AST = a["default"], e.Compiler = l.Compiler, e.JavaScriptCompiler = h["default"], e.Parser = f.parser, e.parse = f.parse, e
        }
        var i = n(8)["default"];
        t.__esModule = !0;
        var s = n(1),
            ...
            g = o["default"].create,
            y = r();
        y.create = r, m["default"](y), y.Visitor = d["default"], y["default"] = y, t["default"] = y, e.exports = t["default"]
    }, function(e, t, n) {
        "use strict";

        function r() {
            var e = new o.HandlebarsEnvironment;
            return h.extend(e, o), e.SafeString = a["default"], e.Exception = l["default"], e.Utils = h, e.escapeExpression = h.escapeExpression, e.VM = d, e.template = function(t) {
        ...
        var s = n(9),
            ...
            m = i(v),
            g = r();
        g.create = r, m["default"](g), g["default"] = g, t["default"] = g, e.exports = t["default"]
    }, function(e, t) {
        "use strict";
        t.__esModule = !0;
        var n = {
            Program: function(e, t, n, r) {
                this.loc = r, this.type = "Program", this.body = e, this.blockParams = t, this.strip = n
            },
            MustacheStatement: function(e, t, n, r, i, s) {
                this.loc = s, this.type = "MustacheStatement", this.path = e, this.params = t || [], this.hash = n, this.escaped = r, this.strip = i
            },
            BlockStatement: function(e, t, n, r, i, s, o, u, a) {
                this.loc = a, this.type = "BlockStatement", this.path = e, this.params = t || [], this.hash = n, this.program = r, this.inverse = i, this.openStrip = s, this.inverseStrip = o, this.closeStrip = u
            },
            PartialStatement: function(e, t, n, r, i) {
                this.loc = i, this.type = "PartialStatement", this.name = e, this.params = t || [], this.hash = n, this.indent = "", this.strip = r
            },
            ContentStatement: function(e, t) {
                this.loc = t, this.type = "ContentStatement", this.original = this.value = e
            },
            CommentStatement: function(e, t, n) {
                this.loc = n, this.type = "CommentStatement", this.value = e, this.strip = t
            },
            SubExpression: function(e, t, n, r) {
                this.loc = r, this.type = "SubExpression", this.path = e, this.params = t || [], this.hash = n
            },
            PathExpression: function(e, t, n, r, i) {
                this.loc = i, this.type = "PathExpression", this.data = e, this.original = r, this.parts = n, this.depth = t
            },
            ...
            HashPair: function(e, t, n) {
                this.loc = n, this.type = "HashPair", this.key = e, this.value = t
            },
            helpers: {
        ...
        function r(e, t) {
            ...
            o["default"].yy = d, d.locInfo = function(e) {
        ...
        function i(e, t, n) {
            if (null == e || "string" != typeof e && "Program" !== e.type) throw new l["default"]("You must pass a string or Handlebars AST to Handlebars.precompile. You passed " + e);
        ...
        function s(e, t, n) {
            function r() {
                var t = n.parse(e, s),
                    r = (new n.Compiler).compile(t, s),
                    i = (new n.JavaScriptCompiler).compile(r, s, void 0, !0);
                return n.template(i)
            }
            ...
            if (null == e || "string" != typeof e && "Program" !== e.type) throw new l["default"]("You must pass a string or Handlebars AST to Handlebars.compile. You passed " + e);
        ...
        var a = n(8)["default"];
        t.__esModule = !0, t.Compiler = r, t.precompile = i, t.compile = s;
        var f = n(11),
            l = a(f),
            c = n(12),
            h = n(2),
        ...
        r.prototype = {
            ...
            compile: function(e, t) {
                ...
                if (t.knownHelpers = {
                    ...
                    for (var r in n) r in n && (t.knownHelpers[r] = n[r]);
            ...
            Program: function(e) {
                ...
                for (var t = e.body, n = t.length, r = 0; n > r; r++) this.accept(t[r]);
            ...
            PartialStatement: function(e) {
                this.usePartial = !0;
                var t = e.params;
                if (t.length > 1) throw new l["default"]("Unsupported number of partial arguments: " + t.length, e);
                t.length || t.push({
                    type: "PathExpression",
                    parts: [],
                    depth: 0
                ...
                r && this.accept(e.name), this.setupFullMustacheParams(e, void 0, void 0, !0);
                var i = e.indent || "";
            ...
            ambiguousSexpr: function(e, t, n) {
                var r = e.path,
                    i = r.parts[0],
                    s = null != t || null != n;
                this.opcode("getContext", r.depth), this.opcode("pushProgram", t), this.opcode("pushProgram", n), this.accept(r), this.opcode("invokeAmbiguous", i, s)
            },
            ...
            helperSexpr: function(e, t, n) {
                ...
                if (this.options.knownHelpers[s]) this.opcode("invokeKnownHelper", r.length, s);
                    ...
                    if (this.options.knownHelpersOnly) throw new l["default"]("You specified knownHelpersOnly, but used the unknown helper " + s, e);
                    i.falsy = !0, this.accept(i), this.opcode("invokeHelper", r.length, i.original, p["default"].helpers.simpleId(i))
                }
            },
            PathExpression: function(e) {
                this.addDepth(e.depth), this.opcode("getContext", e.depth);
                var t = e.parts[0],
                    n = p["default"].helpers.scopedId(e),
                    r = !e.depth && !n && this.blockParamIndex(t);
                r ? this.opcode("lookupBlockParam", r, e.parts) : t ? e.data ? (this.options.data = !0, this.opcode("lookupData", e.depth, e.parts)) : this.opcode("lookupOnContext", e.parts, e.falsy, n) : this.opcode("pushContext")
            },
            ...
            Hash: function(e) {
                var t = e.pairs,
                    n = 0,
                    r = t.length;
                for (this.opcode("pushHash"); r > n; n++) this.pushParam(t[n].value);
            ...
            classifySexpr: function(e) {
                var t = p["default"].helpers.simpleId(e.path),
                    ...
                    r = !n && p["default"].helpers.helperExpression(e),
                    i = !n && (r || t);
                if (i && !r) {
            ...
            pushParam: function(e) {
                ...
                if (this.stringParams) t.replace && (t = t.replace(/^(\.?\.\/)*/g, "").replace(/\//g, ".")), e.depth && this.addDepth(e.depth), this.opcode("getContext", e.depth || 0), this.opcode("pushStringParam", t, e.type), "SubExpression" === e.type && this.accept(e);
                    ...
                    if (this.trackIds) {
                        var n = void 0;
                        if (!e.parts || p["default"].helpers.scopedId(e) || e.depth || (n = this.blockParamIndex(e.parts[0])), n) {
        ...
        function s(e, t, n, r) {
            var i = t.popStack(),
                s = 0,
                o = n.length;
            for (e && o--; o > s; s++) i = t.nameLookup(i, n[s], r);
        ...
        i.prototype = {
            ...
            compilerInfo: function() {
                var e = u.COMPILER_REVISION,
                    t = u.REVISION_CHANGES[e];
                return [e, t]
            },
            ...
            compile: function(e, t, n, r) {
                ...
                var i = e.opcodes,
                    ...
                    u = void 0,
                    a = void 0;
                for (u = 0, a = i.length; a > u; u++) s = i[u], this.source.currentLocation = s.loc, o = o || s.loc, this[s.opcode].apply(this, s.args);
                if (this.source.currentLocation = o, this.pushSource(""), this.stackSlot || this.inlineStack.length || this.compileStack.length) throw new f["default"]("Compile completed with content left on stack");
                ...
                for (u = 0, a = h.length; a > u; u++) h[u] && (c[u] = h[u]);
                ...
                }, c = this.objectLiteral(c), t.srcName ? (c = c.toStringWithSourceMap({
                    file: t.destName
            ...
            createFunctionContext: function(e) {
                ...
                return e ? (o.push(u), Function.apply(this, o)) : this.source.wrap(["function(", o.join(","), ") {\n  ", u, "}"])
            },
            ...
            lookupOnContext: function(e, t, n) {
                var r = 0;
                n || !this.options.compat || this.lastContext ? this.pushContext() : this.push(this.depthedLookup(e[r++])), this.resolvePath("context", e, r, t)
            },
            ...
            resolvePath: function(e, t, n, r) {
                var i = this;
                if (this.options.strict || this.options.assumeObjects) return void this.push(s(this.options.strict, this, t, e));
                for (var o = t.length; o > n; n++) this.replaceStack(function(s) {
                    var o = i.nameLookup(s, t[n], e);
                    return r ? [" && ", o] : [" != null ? ", o, " : ", s]
                })
            },
            ...
            invokePartial: function(e, t, n) {
                var r = [],
                    i = this.setupParams(t, 1, r, !1);
                e && (t = this.popStack(), delete i.name), n && (i.indent = JSON.stringify(n)), i.helpers = "helpers", i.partials = "partials", r.unshift(e ? t : this.nameLookup("partials", t, "partial")), this.options.compat && (i.depths = "depths"), i = this.objectLiteral(i), r.push(i), this.push(this.source.functionCall("this.invokePartial", "", r))
            },
            ...
            replaceStack: function(e) {
                ...
                if (o instanceof r) n = [o.value], t = ["(", n], s = !0;
                else {
                    i = !0;
                ...
                var a = e.call(this, n);
                s || this.popStack(), i && this.stackSlot--, this.push(t.concat(a, ")"))
            },
            incrStack: function() {
            ...
            setupParams: function(e, t, n) {
                var r = {},
                    ...
                    o = [],
                    u = void 0;
                r.name = this.quotedString(e), r.hash = this.popStack(), this.trackIds && (r.hashIds = this.popStack()), this.stringParams && (r.hashTypes = this.popStack(), r.hashContexts = this.popStack());
                var a = this.popStack(),
                    f = this.popStack();
                (f || a) && (r.fn = f || "this.noop", r.inverse = a || "this.noop");
                for (var l = t; l--;) u = this.popStack(), n[l] = u, this.trackIds && (o[l] = this.popStack()), this.stringParams && (s[l] = this.popStack(), i[l] = this.popStack());
                return this.trackIds && (r.ids = this.source.generateArray(o)), this.stringParams && (r.types = this.source.generateArray(s), r.contexts = this.source.generateArray(i)), this.options.data && (r.data = "data"), this.useBlockParams && (r.blockParams = "blockParams"), r
            },
            setupHelperArgs: function(e, t, n, r) {
                var i = this.setupParams(e, t, n, !0);
        ...
        r.prototype = {
            ...
            acceptKey: function(e, t) {
                ...
                if (this.mutating) {
                    if (n && (!n.type || !a["default"][n.type])) throw new o["default"]('Unexpected node type "' + n.type + '" found when accepting ' + t + " on " + e.type);
                    e[t] = n
                }
            },
        ...
        function i(e) {
            e.registerHelper("helperMissing", function() {
                ...
                function n(t, n, i) {
                    f && (f.key = t, f.index = n, f.first = 0 === n, f.last = !!i, c && (f.contextPath = c + t)), u += r(e[t], {
                        data: f,
                ...
                var r = t.fn,
                    ...
                    f = void 0,
                    c = void 0;
                if (t.data && t.ids && (c = a.appendContextPath(t.data.contextPath, t.ids[0]) + "."), v(e) && (e = e.call(this)), t.data && (f = s(t.data)), e && "object" == typeof e)
                    if (d(e))
                        for (var h = e.length; h > o; o++) n(o, o, o === e.length - 1);
                    else {
                        var p = void 0;
                        for (var m in e) e.hasOwnProperty(m) && (p && n(p, o - 1), p = m, o++);
                        p && n(p, o - 1, !0)
                    } return 0 === o && (u = i(this)), u
            }), e.registerHelper("if", function(e, t) {
                return v(e) && (e = e.call(this)), !t.hash.includeZero && !e || a.isEmpty(e) ? t.inverse(this) : t.fn(this)
        ...
        var o = n(8)["default"];
        t.__esModule = !0, t.HandlebarsEnvironment = r, t.createFrame = s;
        var u = n(12),
            a = o(u),
            f = n(11),
            l = o(f),
        ...
        r.prototype = {
            ...
            registerPartial: function(e, t) {
                if (m.call(e) === g) a.extend(this.partials, e);
                else {
                    if ("undefined" == typeof t) throw new l["default"]("Attempting to register a partial as undefined");
                    this.partials[e] = t
                }
            },
        ...
        function n(e, t) {
            var i = t && t.loc,
                s = void 0,
                o = void 0;
            i && (s = i.start.line, o = i.start.column, e += " - " + s + ":" + o);
            for (var u = Error.prototype.constructor.call(this, e), a = 0; a < r.length; a++) this[r[a]] = u[r[a]];
            Error.captureStackTrace && Error.captureStackTrace(this, n), i && (this.lineNumber = s, this.column = o)
        }
        t.__esModule = !0;
        ...
        function s(e) {
            ...
            return c.test(e) ? e.replace(l, n) : e
        }
        ...
        t.__esModule = !0, t.extend = r, t.indexOf = i, t.escapeExpression = s, t.isEmpty = o, t.blockParams = u, t.appendContextPath = a;
        var f = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
        ...
        function i(e, t) {
            function n(n, r, i) {
                i.hash && (r = h.extend({}, r, i.hash)), n = t.VM.resolvePartial.call(this, n, r, i);
                ...
                if (null == s && t.compile && (i.partials[i.name] = t.compile(n, e.compilerOptions, t), s = i.partials[i.name](r, i)), null != s) {
                    if (i.indent) {
                        for (var o = s.split("\n"), u = 0, a = o.length; a > u && (o[u] || u + 1 !== a); u++) o[u] = i.indent + o[u];
                        s = o.join("\n")
                    }
                    return s
                }
            ...
            function r(t) {
                var n = void 0 === arguments[1] ? {} : arguments[1],
                    s = n.data;
                r._setup(n), !n.partial && e.useData && (s = f(t, s));
                var o = void 0,
                    u = e.useBlockParams ? [] : void 0;
                return e.useDepths && (o = n.depths ? [t].concat(n.depths) : [t]), e.main.call(i, t, i.helpers, i.partials, s, u, o)
            }
            ...
            var i = {
                ...
                program: function(e, t, n, r, i) {
                    var o = this.programs[e],
                        u = this.fn(e);
                    return t || i || r || n ? o = s(this, e, u, t, n, r, i) : o || (o = this.programs[e] = s(this, e, u)), o
                },
                data: function(e, t) {
                    for (; e && t--;) e = e._parent;
                    return e
        ...
        function s(e, t, n, r, i, s, o) {
            ...
            return u.program = t, u.depth = o ? o.length : 0, u.blockParams = i || 0, u
        }
        ...
        function u(e, t, n) {
            if (n.partial = !0, void 0 === e) throw new d["default"]("The partial " + n.name + " could not be found");
        ...
        var l = n(8)["default"];
        t.__esModule = !0, t.checkRevision = r, t.template = i, t.wrapProgram = s, t.resolvePartial = o, t.invokePartial = u, t.noop = a;
        var c = n(12),
            h = l(c),
            p = n(11),
            d = l(p),
                    ...
                    performAction: function(e, t, n, r, i, s) {
                        ...
                        switch (i) {
                            case 1:
                                return s[o - 1];
                            case 2:
                                this.$ = new r.Program(s[o], null, {}, r.locInfo(this._$));
                                break;
                            case 3:
                                this.$ = s[o];
                                break;
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                this.$ = new r.CommentStatement(r.stripComment(s[o]), r.stripFlags(s[o], s[o]), r.locInfo(this._$));
                                break;
                            case 9:
                                this.$ = new r.ContentStatement(s[o], r.locInfo(this._$));
                                break;
                            case 10:
                                this.$ = r.prepareRawBlock(s[o - 2], s[o - 1], s[o], this._$);
                                break;
                            case 11:
                                this.$ = {
                                    path: s[o - 3],
                            ...
                            case 17:
                                ...
                                break;
                            case 18:
                                var u = r.prepareBlock(s[o - 2], s[o - 1], s[o], s[o], !1, this._$),
                                    a = new r.Program([u], null, {}, r.locInfo(this._$));
                                a.chained = !0, this.$ = {
                                    strip: s[o - 2].strip,
                                    program: a,
                                    chain: !0
                            ...
                            case 20:
                                ...
                                break;
                            case 21:
                                this.$ = r.prepareMustache(s[o - 3], s[o - 2], s[o - 1], s[o - 4], r.stripFlags(s[o - 4], s[o]), this._$);
                                break;
                            case 22:
                                this.$ = r.prepareMustache(s[o - 3], s[o - 2], s[o - 1], s[o - 4], r.stripFlags(s[o - 4], s[o]), this._$);
                                break;
                            case 23:
                                this.$ = new r.PartialStatement(s[o - 3], s[o - 2], s[o - 1], r.stripFlags(s[o - 4], s[o]), r.locInfo(this._$));
                                break;
                            case 24:
                                this.$ = s[o];
                                break;
                            case 25:
                                ...
                                break;
                            case 26:
                                this.$ = new r.SubExpression(s[o - 3], s[o - 2], s[o - 1], r.locInfo(this._$));
                                break;
                            case 27:
                                this.$ = new r.Hash(s[o], r.locInfo(this._$));
                                break;
                            case 28:
                                this.$ = new r.HashPair(r.id(s[o - 2]), s[o], r.locInfo(this._$));
                                break;
                            case 29:
                                this.$ = r.id(s[o - 1]);
                                break;
                            ...
                            case 31:
                                ...
                                break;
                            case 32:
                                this.$ = new r.StringLiteral(s[o], r.locInfo(this._$));
                                break;
                            case 33:
                                this.$ = new r.NumberLiteral(s[o], r.locInfo(this._$));
                                break;
                            case 34:
                                this.$ = new r.BooleanLiteral(s[o], r.locInfo(this._$));
                                break;
                            case 35:
                            ...
                            case 38:
                                ...
                                break;
                            case 39:
                                this.$ = r.preparePath(!0, s[o], this._$);
                                break;
                            case 40:
                                this.$ = r.preparePath(!1, s[o], this._$);
                                break;
                            case 41:
                                s[o - 2].push({
                                    part: r.id(s[o]),
        ...
        var f = n(6),
            l = a(f);
        r.prototype = new l["default"], r.prototype.Program = function(e) {
            var t = !this.isRootSeen;
            this.isRootSeen = !0;
            for (var n = e.body, r = 0, a = n.length; a > r; r++) {
                var f = n[r],
                    l = this.accept(f);
                if (l) {
                    var c = i(n, r, t),
                        p = s(n, r, t),
                        d = l.openStandalone && c,
                        v = l.closeStandalone && p,
                        m = l.inlineStandalone && c && p;
                    l.close && o(n, r, !0), l.open && u(n, r, !0), m && (o(n, r), u(n, r) && "PartialStatement" === f.type && (f.indent = /([ \t]+$)/.exec(n[r - 1].original)[1])), d && (o((f.program || f.inverse).body), u(n, r)), v && (o(n, r), u((f.inverse || f.program).body))
                }
            }
            return e
        }, r.prototype.BlockStatement = function(e) {
            ...
            var t = e.program || e.inverse,
                ...
                a = n;
            if (n && n.chained)
                for (r = n.body[0].program; a.chained;) a = a.body[a.body.length - 1].program;
            var f = {
            ...
            if (e.openStrip.close && o(t.body, null, !0), n) {
                ...
                l.open && u(t.body, null, !0), l.close && o(r.body, null, !0), e.closeStrip.open && u(a.body, null, !0), i(t.body) && s(r.body) && (u(t.body), o(r.body))
            } else e.closeStrip.open && u(t.body, null, !0);
            return f
        }, r.prototype.MustacheStatement = function(e) {
            return e.strip
        ...
        function u(e, t, n) {
            n = this.locInfo(n);
            for (var r = e ? "@" : "", i = [], s = 0, o = "", u = 0, a = t.length; a > u; u++) {
                var f = t[u].part,
                    l = t[u].original !== f;
                if (r += (t[u].separator || "") + f, l || ".." !== f && "." !== f && "this" !== f) i.push(f);
                else {
                    if (i.length > 0) throw new p["default"]("Invalid path: " + r, {
                        loc: n
                    });
                    ".." === f && (s++, o += "../")
                }
            }
            return new this.PathExpression(e, s, i, r, n)
        }
        ...
        function f(e, t, n, r) {
            if (e.path.original !== n) {
                ...
                throw new p["default"](e.path.original + " doesn't match " + n, i)
            }
            r = this.locInfo(r);
            var s = new this.Program([t], null, {}, r);
            return new this.BlockStatement(e.path, e.params, e.hash, s, void 0, {}, {}, {}, r)
        }
        ...
        function l(e, t, n, r, i, s) {
            if (r && r.path && e.path.original !== r.path.original) {
                ...
                throw new p["default"](e.path.original + " doesn't match " + r.path.original, o)
            }
            t.blockParams = e.blockParams;
            var u = void 0,
                a = void 0;
            return n && (n.chain && (n.program.body[0].closeStrip = r.strip), a = n.strip, u = n.program), i && (i = u, u = t, t = i), new this.BlockStatement(e.path, e.params, e.hash, t, u, e.strip, a, r && r.strip, this.locInfo(s))
        }
        var c = n(8)["default"];
        t.__esModule = !0, t.SourceLocation = r, t.id = i, t.stripFlags = s, t.stripComment = o, t.preparePath = u, t.prepareMustache = a, t.prepareRawBlock = f, t.prepareBlock = l;
        var h = n(11),
            p = c(h)
    }, function(e, t, n) {
        "use strict";
        ...
        function r(e, t, n) {
            if (s.isArray(e)) {
                for (var r = [], i = 0, o = e.length; o > i; i++) r.push(t.wrap(e[i], n));
                return r
            }
        ...
        o || (o = function(e, t, n, r) {
            ...
            generateList: function(e, t) {
                for (var n = this.empty(t), i = 0, s = e.length; s > i; i++) i && n.add(","), n.add(r(e[i], this, t));
                return n
            },
            generateArray: function(e, t) {
                var n = this.generateList(e, t);
                return n.prepend("["), n.add("]"), n
            }
        }, t["default"] = i, e.exports = t["default"]
    }])
}), define("utils/RatioHelper", [], function() {
    var e = function() {
        function e() {}
        return e.prototype.cover = function(e) {
            var t, n;
            return n = e.objectDimensions.width / e.objectDimensions.height, t = {}, t.width = e.bounds.width, t.height = Math.round(e.bounds.width / n), t.top = Math.round((e.bounds.height - t.height) / 2), t.left = 0, t.height < e.bounds.height && (t.top = 0, t.width = Math.round(e.bounds.height * n), t.height = e.bounds.height, t.left = Math.round((e.bounds.width - t.width) / 2)), t
        }, e.prototype.maxScale = function(e) {
            var t, n;
            return n = e.objectDimensions.width / e.objectDimensions.height, t = {}, t.width = e.bounds.width, t.height = Math.round(e.bounds.width / n), t.top = Math.round((e.bounds.height - t.height) / 2), t.left = 0, t.height > e.bounds.height && (t.top = 0, t.width = Math.round(e.bounds.height * n), t.height = e.bounds.height, t.left = Math.round((e.bounds.width - t.width) / 2)), t
        }, e
    }();
    ...
    return t
}), define("text!templates/intro/IntroView.hbs", [], function() {
    return '<div class="poster">\n	<div class="bttnPlay"></div>\n</div>\n<iframe width="560" height="315" src="https://www.youtube.com/embed/{{youtubeId}}?rel=0&showinfo=0&autohide=1&iv_load_policy=1&wmode=transparent" frameborder="0" allowfullscreen></iframe>'
}), define("views/intro/IntroView", ["App", "backbone", "handlebars", "utils/RatioHelper", "text!templates/intro/IntroView.hbs"], function(e, t, n, r, i) {
    var s = t.View.extend({
        player: null,
        isPlayerReady: !1,
        isWaitingOnPlayer: !1,
        ...
        el: "#intro",
        events: {
            "click button.skip": "skipVideo",
            "click .poster": "onPosterClick"
        },
        initialize: function() {
            this.$videoContainer = this.$el.find(".videoContainer"), this.$skipLabel = this.$el.find(".skip .label"), this.$poster = this.$el.find(".poster"), this.initEvents()
        },
        initEvents: function() {
            function s() {
                var s = r.cover({
                    ...
                    o = e.translate("intro");
                t.player = new YT.Player(t.$videoContainer.get(0), {
                    width: s.width,
                    height: s.height,
                    videoId: o.youtubeId,
                    playerVars: {
            ...
            var t = this,
                n = _.bind(this.onPlayerStateChange, this),
                i = _.bind(this.onPlayerReady, this);
            setTimeout(function() {
            ...
            }, 100), window.vent.on("Locale:initialSet", _.bind(this.render, this)), window.vent.on("PageChange", _.bind(this.onPageChange, this)), window.vent.on("App:onResize", _.bind(this.onResize, this))
        },
        onPageChange: function(t) {
            var n = this;
            t.id === "intro" ? (this.$el.hasClass("inactive") && this.$el.removeClass("inactive"), this.$el.hasClass("disabled") && this.$el.removeClass("disabled"), this.$skipLabel.text(e.translate("intro").label), this.playVideo(), this.$poster.hide()) : (this.$el.hasClass("inactive") || this.$el.addClass("inactive"), n.$el.hasClass("disabled") || (clearTimeout(this.disableTimer), this.disableTimer = setTimeout(function() {
                n.$el.addClass("disabled")
            }, 900)), this.player != null && typeof(this.player.stopVideo !== "undefined") && this.player.stopVideo())
        },
        onPosterClick: function() {
            this.player != null && typeof this.player.playVideo != "undefined" && this.player.playVideo(), this.$poster.hide()
        },
        onPlayerComplete: function() {
            var t = this;
            this.$el.hasClass("inactive") || this.$el.addClass("inactive"), e.navigateTo("/map")
        },
        onPlayerReady: function(e) {
            this.$videoContainer = this.$el.find(".videoContainer"), this.onResize(), e.target.stopVideo(), this.isPlayerReady = !0, this.isWaitingOnPlayer && e.target.playVideo()
        },
        onPlayback: function() {
            if (this.duration == 0) return;
            var e = Math.floor(this.player.getCurrentTime());
            !this.hasMapRendered && e >= this.duration * .2 && (this.hasMapRendered = !0, window.vent.trigger("Map:ExternalRenderRequest", "IntroView")), e >= Math.floor(this.duration * .94) && !this.hasAutofadedOut && (this.hasAutofadedOut = !0, this.$el.addClass("inactive"), clearInterval(this.playbackInterval))
        },
        onPlayerStateChange: function(t) {
            ...
            if (typeof t.data != undefined) {
                ...
                if (t.data === YT.PlayerState.PLAYING) {
                    this.isPosterVisible && (this.isPosterVisible = !1, this.$poster.hide()), clearInterval(this.playbackInterval), this.playbackInterval = setInterval(function() {
                        n.onPlayback()
                    }, 250);
                    return
                }
                if (t.data === YT.PlayerState.ENDED) {
                    this.isPosterVisible || (this.isPosterVisible = !0, this.$poster.show()), e.trackEvent("introVideo", "completed"), this.onPlayerComplete(), clearInterval(this.playbackInterval);
                    return
                }
                if (t.data === YT.PlayerState.PAUSED) {
                    clearInterval(this.playbackInterval);
                    return
                }
                t.data === YT.PlayerState.BUFFERING && this.isPosterVisible && (this.isPosterVisible = !1, this.$poster.hide())
            }
        },
        onResize: function(t) {
            if (!t) var t = {
            ...
            var n = r.cover({
                ...
                i = t.height - n.height - 5;
            this.$videoContainer.attr("width", n.width), this.$videoContainer.attr("height", n.height), this.$videoContainer.css({
                position: "relative",
                marginTop: i + "px",
        ...
        render: function() {},
        playVideo: function() {
            var e = this.isMobileTablet();
            if (e) return;
            this.isPlayerReady ? (this.player.seekTo(0), this.player.playVideo()) : this.isWaitingOnPlayer = !0
        },
        skipVideo: function() {
            e.trackEvent("introVideo", "skipped"), this.onPlayerComplete(), this.player != null && typeof this.player.stopVideo != "undefined" && this.player.stopVideo()
        },
    ...
    return s
}), define("text!templates/index/IndexView.hbs", [], function() {
    return '<div class="title">\n    <img class="dreamworks" src="images/views/index/dreamworks-light.png"/>\n    <img class="logo" alt="titleGraphicAlt" src="{{titleGraphic}}"/>\n</div>\n<p class="shadow">{{{introText}}}</p>\n<div class="button-container"><a class="button shadow exploreMap" href="/intro">{{exploreMap}}</a></div>'
}), define("views/index/IndexView", ["App", "views/index/LanguageSelectorView", "views/intro/IntroView", "backbone", "handlebars", "utils/LocalizationHelper", "text!templates/index/IndexView.hbs"], function(e, t, n, r, i, s, o) {
    var u = r.View.extend({
        introView: null,
        hasRendered: !1,
        disableTimeout: 0,
        el: "#index",
        events: {
            "change .localeSelect": "onLocaleSelectChange"
        },
        initialize: function() {
            this.$contentContainer = this.$el.find(".content"), this.$localeSelect = this.$el.find(".localeSelect"), this.initEvents(), this.introView = new n, this.languageSelector = new t
        },
        initEvents: function() {
            window.vent.on("Locale:change", _.bind(this.onLocaleChange, this)), window.vent.on("PageChange", _.bind(this.onPageChange, this))
        },
        onPageChange: function(e) {
            var t = this;
            e.id === "index" ? (this.$el.hasClass("disabled") ? (this.$el.removeClass("disabled"), setTimeout(function() {
                t.$el.hasClass("inactive") && t.$el.removeClass("inactive")
            }, 20)) : this.$el.hasClass("inactive") ? this.$el.removeClass("inactive") : this.$el.addClass("active"), this.hasRendered || (this.render(), setTimeout(function() {
                t.$el.addClass("active")
            }, 20))) : (this.$el.hasClass("inactive") || this.$el.addClass("inactive"), this.$el.hasClass("disabled") || (clearTimeout(this.disableTimeout), this.disableTimeout = setTimeout(function() {
        ...
        onLocaleSelectChange: function(t) {
            var n = $(t.currentTarget),
                r = n.val(),
                i = this.$localeSelect.find(":selected").index();
            this.languageSelector.update(i), this.$localeSelect.prepend(this.$localeSelect.find(":selected")), e.router.navigate("#/" + r, {
                trigger: !0
            })
        },
        playIntro: function() {
            this.$el.hasClass("inactive") || this.$el.addClass("inactive"), this.introView.playVideo()
        },
        render: function() {
            this.hasRendered = !0;
            var t = e.translate("index");
            hbs = i.compile(o), this.$contentContainer.html(hbs(t)), this.$localeSelect.find("option[value='" + s.currentLocale.get("code") + "']").prop("selected", !0);
            var n = this;
            this.$el.find(".button").on("mouseover", function() {
                n.$el.find(".button-container").addClass("show")
            }), this.$el.find(".button").on("mouseout", function() {
                n.$el.find(".button-container").removeClass("show")
            })
        }
    });
    return u
}), define("text!templates/map/MenuView.hbs", [], function() {
    return '<div class="menuMinHeight">\n	<div class="logo" style="background-image: url({{logoLockup}})"></div>\n	<div class="addPadding">\n		<div class="toggleMarkers">\n			<div class="checkbox">\n				<input type="checkbox" id="enableMarkers" checked="checked" />\n				<label for="enableMarkers"><span>{{showMapMarkers}}</span></label>\n			</div> \n		</div>\n		<span class="visitMoreSites">{{visitMoreSites}}</span>\n		<ul class="moreSites">\n			{{#navItems}}				\n				<li><a {{^coppa}}class="no-coppa"{{/coppa}} href="{{url}}" target="_blank">{{label}}</a></li>\n			{{/navItems}}\n		</ul>\n		{{#allEpisodesStreamingLockup}}\n			<div class="streamingEpisodes">\n				<img src="{{.}}" />\n			</div>\n		{{/allEpisodesStreamingLockup}}\n	</div>\n	<div class="footer">\n		<div class="social">\n			<ul>\n				{{#if social.facebook.length}}\n					<li><a href="{{social.facebook}}" target="_blank"><i class="icon facebook"></i></a></li>\n				{{/if}}\n				{{#if social.tumblr.length}}\n					<li><a href="{{social.tumblr}}" target="_blank"><i class="icon tumblr"></i></a></li>\n				{{/if}}\n			</ul>\n		</div>\n		<footer></footer>\n	</div>\n</div>'
}), define("text!templates/common/Footer.hbs", [], function() {
    return '<div class="copyright">{{{copyright}}}</div>\n<div class="links">\n{{#links}}\n	<a class="{{id}} no-coppa" target="_blank" href="{{url}}">{{label}}</a>\n{{/links}}\n</div>\n<img class="dreamworks" src="images/views/common/footer-dreamworks.png"/>\n{{#if ratingsVisible}}\n<img class="ratingImage" data-light="{{ratingsImage}}" src="{{ratingsImage}}"/>\n{{/if}}'
}), define("views/map/MenuView", ["backbone", "App", "handlebars", "text!templates/map/MenuView.hbs", "text!templates/common/Footer.hbs"], function(e, t, n, r, i) {
    var s = e.View.extend({
        el: "#mapMenu",
        model: null,
        isVisible: !1,
        events: {
            "change #enableMarkers": "onToggleMarkers"
        },
        initialize: function() {
            this.initEvents()
        },
        initEvents: function() {
            window.vent.on("Map:Menu:toggle", _.bind(this.toggleMobileMenu, this))
        },
        onToggleMarkers: function() {
            t.trackEvent("toggleMarkers", "clicked"), window.vent.trigger("Map:toggleMarkers")
        },
        render: function() {
            this.model == null && this.setModel();
            var e = t.translate("legal"),
                s = n.compile(r),
                o = n.compile(i);
            this.$el.html(s(this.model)), this.$el.find("footer").html(o(e)), this.delegateEvents()
        },
        setModel: function() {
            this.model = t.translate("menu"), this.model.legal = t.translate("legal"), this.model.social = t.translate("social")
        },
        toggleMobileMenu: function() {
            this.isVisible ? (this.isVisible = !1, this.$el.removeClass("active")) : (this.isVisible = !0, this.$el.hasClass("active") || this.$el.addClass("active"))
        }
    });
    return s
}), define("text!templates/map/InfoView.hbs", [], function() {
    return '<div class="panel info">\n	<div class="head">\n		<button class="close">x</button>\n		<div class="title">{{name}}</div>\n	</div>\n	{{#if info.thumbnail}}\n		{{#if hasDetail}}\n			<div class="thumbnail clickable" data-type="{{type}}" data-slug="{{slug}}" style="background-image: url({{info.thumbnail}});">\n		{{/if}}\n		{{^if hasDetail}}\n			<div class="thumbnail" style="background-image: url({{info.thumbnail}});">\n		{{/if}}\n			{{#if hasDetail}}\n				<div class="photosCount"><i class="icon camera"></i> <span>{{photos.length}} {{text.photos}}</span></div>\n			{{/if}}\n		</div>\n	{{/if}}\n	\n	{{#if isDragon}}\n		<div class="meta">\n			<strong>{{text.class}}</strong>	{{info.class}}\n		</div>\n	{{/if}}\n\n	{{#if info.summary.length}}\n		<p>{{{info.summary}}}</p>\n	{{/if}}\n</div>\n{{#if isLocation}}\n	<div class="panel ratings">\n		<div class="flyingTime column">\n			<div class="time">{{info.flyingTime}}</div>\n			{{#if isDragonsEdge}}\n				<div class="smallText">{{text.viaDragonToBerk}}</div>\n			{{/if}}\n			{{#if isNotDragonsEdge}}\n				<div class="smallText">{{text.viaDragon}}</div>\n			{{/if}}\n		</div>\n		<div class="ratings column">\n			<div class="wings">\n				<div class="ratingCount"></div>\n			</div>\n			<div class="smallText">{{info.numRatings}} {{text.ratings}}</div>\n		</div>\n		<div class="clear"></div>\n	</div>\n{{/if}}\n{{#if hasDetail}}\n	<button class="findOutMore" data-type="{{type}}" data-slug="{{slug}}">{{text.findOutMore}}</button>\n{{/if}}'
}), define("views/map/InfoView", ["backbone", "App", "handlebars", "text!templates/map/InfoView.hbs"], function(e, t, n, r) {
    var i = e.View.extend({
        el: "#infoView",
        model: null,
        template: null,
        ...
        currSlug: "",
        events: {
            "click button.findOutMore": "onClickFindOutMore",
            "click button.close": "close",
            "click .thumbnail.clickable": "onClickThumbnail"
        },
        initialize: function() {
            this.template = n.compile(r)
        },
        animateIn: function(e) {
            var t = this.$el.find(".panel"),
                n = this.$el.find("button.findOutMore"),
                r = this.$el.find(".ratingCount"),
                i = 90;
            setTimeout(function() {
                var s = 0;
                t.each(function() {
        ...
        close: function() {
            ...
            this.currSlug = "", this.isActive = !1;
            var e = 90,
                t = this.$el.find(".panel"),
                n = this.$el.find("button.findOutMore"),
                r = 1,
                i = this;
            t = $(t.get().reverse()), n.removeClass("active"), t.each(function() {
                var t = $(this);
                setTimeout(function() {
        ...
        onClickFindOutMore: function(e) {
            var n = $(e.currentTarget),
                r = n.attr("data-slug"),
                i = n.attr("data-type");
            t.trackEvent("detailViewSelected", i + "/" + r), t.navigateTo("/" + i + "/" + r)
        },
        onClickThumbnail: function(e) {
            this.onClickFindOutMore(e), setTimeout(function() {
                window.vent.trigger("Map:InfoView:ThumbnailSelected")
            }, 300)
        },
        onMarkerSelect: function(e, n) {
            if (n == this.currSlug) return;
            var r, i = this,
                s, o = t.translate("map.info"),
                u = 10;
            e === "dragon" ? (s = t.translate("dragons." + n), t.trackEvent("markerSelected", "dragons-" + n)) : (s = t.translate("locations." + n), t.trackEvent("markerSelected", "locations-" + n)), s.slug = n, s.text = o, s.type = e, s.isDragon = e === "dragon", s.isLocation = e === "location", s.isDragonsEdge = n === "dragons-edge", s.isNotDragonsEdge = n !== "dragons-edge", this.isActive && (this.close(), u = 460), this.currSlug = n, setTimeout(function() {
                var e = 0;
                typeof s.info.ratingCount != "undefined" && (e = String(s.info.ratingCount), e = e.replace(".", "_")), i.$el.html(i.template(s)), i.delegateEvents(), i.animateIn(e)
            }, u), this.isActive = !0
        }
    });
    return i
}), define("views/map/MobileOverlayView", ["backbone", "App"], function(e, t) {
    var n = e.View.extend({
        el: "#mobileOverlayView",
        isVisible: !1,
        $mobileLogo: null,
        events: {
            click: "toggleMenu"
        ...
        initialize: function() {
            this.initEvents(), this.$mobileLogo = $("#mobileHeader .logo")
        },
        initEvents: function() {
            window.vent.on("Map:Menu:toggle", _.bind(this.onMenuToggle, this))
        },
        onMenuToggle: function(e) {
            this.isVisible ? (this.isVisible = !1, this.hide()) : (this.isVisible = !0, this.show())
        },
        hide: function() {
            var e = this;
            this.$el.removeClass("visible"), setTimeout(function() {
                e.$el.removeClass("active"), e.$el.removeClass("transitioned")
            }, 500), this.$mobileLogo.removeClass("hidden")
        },
        show: function() {
            var e = this;
            this.$el.addClass("active"), setTimeout(function() {
                e.$el.hasClass("transitioned") || e.$el.addClass("transitioned"), setTimeout(function() {
                    e.$el.hasClass("visible") || e.$el.addClass("visible")
                }, 10)
            }, 10), this.$mobileLogo.hasClass("hidden") || this.$mobileLogo.addClass("hidden")
        },
        toggleMenu: function() {
            window.vent.trigger("Map:Menu:toggle", "mobileOverlayView")
        }
    });
    return n
}), define("views/map/DecorativeMarkers", [], function() {
    return {
        waves: [
            [8.177550862824049, 17.6025390625],
            [4.9911242573860175, 9.8681640625],
            [5.603727903927672, 1.6943359375],
            [-5.409535581776376, .5517578125],
            [-9.807814695237813, -3.4912109375],
            [-13.593893063693667, 6.66015625],
            [-15.380826001278487, 19.2724609375],
            [-9.027466877730427, 27.0947265625],
            [3.939653146367535, 34.8291015625],
            [20.126905993745808, 30.6982421875],
            [18.21765220103298, -2.7001953125],
            [14.932884261261668, -33.9013671875],
            [-23.644524198573674, -7.822265625],
            [-29.228890030194215, 26.455078125]
        ],
        clouds: [
            [-35.07605379272801, 18.720703125],
            [-33.21111647241684, -30.322265625],
            [29.305561325527698, 52.91015625],
            [-6.751896464843362, -8.349609375]
        ],
        boats: [
            [-4.390228926463384, 27.59765625],
            [-18.729501999072138, -4.39453125],
            [2.460181181021018, -16.69921875]
        ]
    }
}), define("utils/RequestAnimFrame", [], function() {
...
define("utils/AnimatedSpriteSheetView", ["backbone", "utils/RequestAnimFrame"], function(e) {
    var t, n;
    return t = function(e) {
        function t() {
            return this.onFrame = __bind(this.onFrame, this), n = t.__super__.constructor.apply(this, arguments), n
        }
        return __extends(t, e), t.prototype.height = null, t.prototype.width = null, t.prototype.spriteSheetUrl = null, t.prototype.maxLoops = -1, t.prototype.className = null, t.prototype.fps = 10, t.prototype.hideElement = !1, t.prototype.isAnimating = !0, t.prototype.cols = 0, t.prototype.rows = 0, t.prototype.downloadSuccess = !1, t.prototype.currentFrame = {
            row: 0,
            col: 0
        }, t.prototype.currLoopNum = 0, t.prototype.timeout = 0, t.prototype.lastUpdateTime = 0, t.prototype.NEXT_FRAME = "next_frame", t.prototype.initialize = function(e) {
            return this.height = e.height, this.width = e.width, this.spriteSheetUrl = e.spriteSheetUrl, this.className = e.className, this.hideElement = e.hideElement, e.maxLoops && (this.maxLoops = e.maxLoops), e.fps && (this.fps = e.fps), this.interval = 1e3 / (this.fps || 50), this.initImage()
        }, t.prototype.initImage = function() {
            var e, t;
            return t = this, e = new Image, e.onload = function() {
                return t.cols = Math.ceil(e.width / t.width), t.rows = Math.ceil(e.height / t.height), t.initHtml(!0)
            }, e.onabort = function() {
                return t.initHtml(!1)
            }, e.onerror = function() {
                return t.initHtml(!1)
            }, e.src = this.spriteSheetUrl
        }, t.prototype.initHtml = function(e) {
            return this.downloadSuccess = e, this.className && this.$el.addClass(this.className), this.$el.css({
                width: this.width,
                height: this.height,
                overflow: "hidden",
        ...
        }, t.prototype.onNextFrame = function() {
            var e, t;
            return e = void 0, t = void 0, this.currentFrame.col++, this.currentFrame.col >= this.cols && (this.currentFrame.col = 0, this.currentFrame.row++, this.currentFrame.row >= this.rows && (this.currentFrame.row = 0, this.currLoopNum++, this.currLoopNum === this.maxLoops && this.stop(!0))), e = this.currentFrame.col * -this.width, t = this.currentFrame.row * -this.height, this.$el.css({
                backgroundPosition: e + "px " + t + "px"
            })
        }, t.prototype.onFrame = function() {
            var e, t;
            t = Date.now(), e = t - this.lastUpdateTime, e > this.interval && (this.lastUpdateTime = t - e % this.interval, this.onNextFrame());
            if (this.isAnimating) return requestAnimFrame(this.onFrame)
        }, t.prototype.start = function() {
            if (this.downloadSuccess) {
                requestAnimFrame(this.onFrame);
                if (this.hideElement) return this.$el.css({
                    display: "block"
                })
            }
        }, t.prototype.stop = function(e) {
            return this.hideElement && this.$el.css({
                display: "none"
            }), this.isAnimating = !1
        }, t
    }(e.View)
}), define("text!templates/map/DebugInfo.hbs", [], function() {
    return "Here's some debug info about this position:\n<ul>\n	<li><strong>Latitude:</strong> {{lat}}</li>\n	<li><strong>Longitude:</strong> {{lng}}</li>\n	<li><strong>Distance between points (miles): {{distance}}</strong></li>\n	<li><strong>Pixel X:</strong> {{pixel.x}}</li>\n	<li><strong>Pixel Y:</strong> {{pixel.y}}</li>\n</ul>"
}), define("views/map/MapView", ["backbone", "App", "handlebars", "views/map/MenuView", "views/map/InfoView", "views/map/MobileOverlayView", "views/map/DecorativeMarkers", "utils/AnimatedSpriteSheetView", "text!templates/map/DebugInfo.hbs"], function(e, t, n, r, i, s, o, u, a) {
    var f = e.View.extend({
        el: "#map",
        map: null,
        markers: null,
        ...
        markersVisible: !0,
        menuView: null,
        hasAddedInitialMarkers: !1,
        hasRenderedFromExternalRequest: !1,
        hasRendered: !1,
        isDragonView: !1,
        responsiveBreakpoint: 750,
        dragonViewTipVisible: !0,
        bounds: null,
        mapOptions: {
            minZoom: 4,
            maxZoom: 6,
        ...
        events: {
            "click .dragonViewToggle": "onToggleDragonView",
            "click #mobileHeader button.menu": "onToggleMobileMenu",
            "click .dragonViewTip button.close": "closeDragonViewTip"
        },
        initialize: function() {
            var e = this;
            this.markers = [], this.markerTimeouts = [], this.boundOnLocationSelect = _.bind(this.onLocationSelected, this), this.boundOnDragonsSelect = _.bind(this.onDragonSelected, this), this.$mapContainer = $("#mapContainer"), this.$googleContainer = $("#googleContainer"), this.$dragonViewToggle = this.$el.find(".dragonViewToggle"), this.$dragonViewTip = this.$el.find(".dragonViewTip"), this.$toggleText = this.$dragonViewToggle.find("span"), this.setBounds(), this.menuView = new r, this.infoView = new i, this.initEvents(), this.overlayView = new s
        },
        initEvents: function() {
            window.vent.on("PageChange", _.bind(this.onPageChange, this)), window.vent.on("App:onResize", _.bind(this.onResize, this)), window.vent.on("Map:toggleMarkers", _.bind(this.onToggleMarkers, this)), window.vent.on("Map:ExternalRenderRequest", _.bind(this.onExternalRenderRequest, this))
        },
        initDragonViewTip: function() {},
        addDebugMarker: function() {
            var e = this,
                ...
                o = n.compile(a);
            google.maps.event.addListener(i, "drag", function(n) {
                var r = google.maps.geometry.spherical.computeDistanceBetween(i.getPosition(), s.getPosition());
                n.distance = r, n.lat = n.latLng.toJSON().lat, n.lng = n.latLng.toJSON().lng, n.distance = n.distance * 621371e-9;
                var u = o(n);
                t.setContent(u), t.open(e.map, i)
            }), google.maps.event.addListener(s, "drag", function(n) {
                var r = google.maps.geometry.spherical.computeDistanceBetween(i.getPosition(), s.getPosition());
                n.distance = r, n.lat = n.latLng.toJSON().lat, n.lng = n.latLng.toJSON().lng, n.distance = n.distance * 621371e-9;
                var u = o(n);
                t.setContent(u), t.open(e.map, s)
            })
        },
        clearMarkers: function() {
            for (var e = 0; e < this.markers.length; e++) this.markers[e].setMap(null);
            this.markers = [];
            for (var e = 0; e < this.markerTimeouts.length; e++) clearTimeout(this.markerTimeouts[e]);
            this.markerTimeouts = [];
            for (var e = 0; e < this.decorativeMarkers.length; e++) this.decorativeMarkers[e].setMap(null);
            this.decorativeMarkers = []
        },
        closeDragonViewTip: function() {
            var e = this;
            this.dragonViewTipVisible = !1, this.$dragonViewTip.addClass("hidden"), setTimeout(function() {
                e.$dragonViewTip.remove()
            }, 500)
        },
        onExternalRenderRequest: function(e) {
            this.$el.hasClass("disabled") && this.$el.removeClass("disabled"), this.hasRenderedFromExternalRequest = !0, this.hasRendered || (this.render(), this.hasRendered = !0)
        },
        onLocationSelected: function(e) {
            this.infoView.onMarkerSelect("location", e.slug)
        },
        onMapCenterChanged: function(e) {
            var t = this.map.getBounds(),
                n = t.getNorthEast(),
                r = t.getSouthWest(),
                i = this.map.getCenter();
            if (this.bounds.contains(n) && this.bounds.contains(r)) {
                this.lastValidCenter = i;
                return
            }
            var s = n.lng() - r.lng(),
                o = n.lat() - r.lat(),
                u = i.lng(),
                a = i.lat(),
                f = this.bounds.getNorthEast().lng(),
                l = this.bounds.getNorthEast().lat(),
                c = this.bounds.getSouthWest().lng(),
                h = this.bounds.getSouthWest().lat();
            f -= s / 2, c += s / 2, l -= o / 2, h += o / 2, u < c && (u = c), u > f && (u = f), a < h && (a = h), a > l && (a = l), this.map.panTo(new google.maps.LatLng(a, u))
        },
        ...
        onDragonSelected: function(e) {
            this.infoView.onMarkerSelect("dragon", e.slug)
        },
        onPageChange: function(e) {
            var t = this;
            if (e.id === "map" || e.id === "location" || e.id === "dragon") this.$el.hasClass("disabled") && this.$el.removeClass("disabled"), this.hasRendered || (this.render(), this.hasRendered = !0), this.hasAddedInitialMarkers || (this.hasAddedInitialMarkers = !0, this.setDecorativeMarkers(), this.hasRenderedFromExternalRequest ? this.setLocationMarkers() : this.setLocationMarkers(!0))
        },
        onResize: function(e) {
            if (!e) {
                var e = {};
                e.width = t.$window.width(), e.height = t.$window.height()
            }
            e.width > this.responsiveBreakpoint && (e.width -= 237, e.width -= 10, e.height -= 10), this.$mapContainer.css({
                width: e.width,
                height: e.height
            })
        },
        onToggleMarkers: function() {
            this.markersVisible ? (this.markersVisible = !1, this.clearMarkers()) : (this.markersVisible = !0, this.isDragonView ? this.setDragonMarkers() : this.setLocationMarkers())
        },
        onToggleMobileMenu: function() {
            window.vent.trigger("Map:Menu:toggle", "mapView")
        },
        onToggleDragonView: function() {
            this.map.setMapTypeId(null), this.map.setMapTypeId("dragons"), this.dragonViewTipVisible && this.closeDragonViewTip();
            if (this.isDragonView) {
                this.map.setMapTypeId("regular"), this.$el.removeClass("dragonView"), this.isDragonView = !1, this.clearMarkers();
                if (!this.markersVisible) return;
                this.setDecorativeMarkers(), this.setLocationMarkers(), t.trackEvent("dragonViewToggled", "normalView")
            } else {
                this.map.setMapTypeId("dragonView"), this.$el.addClass("dragonView"), this.isDragonView = !0;
                if (!this.markersVisible) return;
                this.clearMarkers(), this.setDragonMarkers(), t.trackEvent("dragonViewToggled", "dragonView")
            }
        },
        render: function() {
            this.onResize();
            ...
            var e = this,
                n = new google.maps.ImageMapType({
                    getTileUrl: _.bind(this.getTileUrl, this),
                    tileSize: new google.maps.Size(256, 256),
                    maxZoom: this.mapOptions.maxZoom,
                    name: "Dragons-rtte-regular"
                }),
                r = new google.maps.ImageMapType({
                    getTileUrl: _.bind(this.getTileUrl, this),
                    tileSize: new google.maps.Size(256, 256),
                    maxZoom: this.mapOptions.maxZoom,
                    name: "Dragons-rtte-dragonView"
                });
            this.mapOptions.mapTypeControlOptions = {
                mapTypeIds: ["regular", "dragonsView"]
            }, this.$el.find(".dragonViewTip span").html(t.translate("map.dragonViewTip")), this.map = new google.maps.Map(this.$googleContainer.get(0), this.mapOptions), google.maps.event.addListener(this.map, "click", _.bind(this.onMapClick, this)), google.maps.event.addListener(this.map, "drag", _.bind(this.onMapDrag, this)), google.maps.event.addListener(this.map, "center_changed", _.bind(this.onMapCenterChanged, this)), this.map.mapTypes.set("regular", n), this.map.mapTypes.set("dragonView", r), this.map.setMapTypeId("regular"), this.lastValidCenter = this.map.getCenter(), this.menuView.render();
            var i = window.location.href;
            i.indexOf("?debug=1") > 0 && this.addDebugMarker(), $("#mobileHeader").find(".logo").css({
                "background-image": "url(" + t.translate("menu.logoLockup") + ")"
            }), this.setDragonIcon(), this.initDragonViewTip()
        },
        setBounds: function() {
            var e = {
                sw: new google.maps.LatLng(-69.50376519563684, -97.47070312500006),
                ne: new google.maps.LatLng(69.3493386397765, 97.646484375)
            };
            this.bounds = new google.maps.LatLngBounds(e.sw, e.ne)
        },
        setDragonIcon: function() {
            this.dragonViewAnim = new u({
                width: 160,
                height: 160,
                fps: 30,
                spriteSheetUrl: "images/views/map/dragon-view-glow.png",
                el: $(".dragonViewAnim")
            })
        },
        setDecorativeMarkers: function() {
            var e = new google.maps.MarkerImage("images/views/map/decorativeMarker-water.gif", new google.maps.Size(50, 50), new google.maps.Point(0, 0), new google.maps.Point(27, 10)),
                t = new google.maps.MarkerImage("images/views/map/decorativeMarker-cloud.gif", new google.maps.Size(50, 50), new google.maps.Point(0, 0), new google.maps.Point(27, 10)),
                n = new google.maps.MarkerImage("images/views/map/decorativeMarker-boat.gif", new google.maps.Size(100, 100), new google.maps.Point(0, 0), new google.maps.Point(27, 10));
            this.decorativeMarkers = [];
            for (var r = 0; r < o.waves.length; r++) {
                var i = o.waves[r],
                    s = new google.maps.LatLng(i[0], i[1]),
                ...
                this.decorativeMarkers.push(u)
            }
            for (var r = 0; r < o.clouds.length; r++) {
                var a = o.clouds[r],
                    s = new google.maps.LatLng(a[0], a[1]),
                    u = new google.maps.Marker({
                        position: s,
                        map: this.map,
                        icon: t,
        ...
        getMarkerStyle: function() {
            var e = {
                url: "images/views/map/location-marker.png",
                size: new google.maps.Size(53, 61),
                origin: new google.maps.Point(0, 0),
                anchor: new google.maps.Point(22, 56)
            };
            this.isDragonView && (e.url = "images/views/map/dragon-marker.png");
            var t = {
                coords: [1, 1, 1, 42, 42, 57, 57, 1],
                type: "poly"
            };
            return {
                image: e,
        ...
        getTileUrl: function(e, t) {
            var n = "normal",
                r = "";
            this.isDragonView && (n = "dragon"), e && e.x < Math.pow(2, t) && e.x > -1 && e.y < Math.pow(2, t) && e.y > -1 ? r = "images/views/map/tiles/" + n + "/" + t + "_" + e.x + "_" + e.y + ".jpg" : r = "images/views/map/tiles/" + n + "/empty.jpg";
            var i = !1;
            if (i) {
                var s = document.createElement("canvas"),
                    o = document.createElement("img"),
                    u = s.getContext("2d");
                s.setAttribute("height", 256), s.setAttribute("width", 256), o.setAttribute("src", r), u.drawImage(o, 0, 0, 256, 256), u.strokeRect(0, 0, 257, 257), u.font = "11px monospace", u.fillText(t + "_" + e.x + "_" + e.y, 10, 10), typeof document[r] == "undefined" && (o.setAttribute("style", "position: abolute; opacity: 0; width: 1px; height: 1px;"), document.body.appendChild(o), document[r] = o), r = s.toDataURL("image/jpeg", 1)
            }
            return r
        },
        setDragonMarkers: function() {
            var e = this.getMarkerStyle(),
                n = this;
            this.$toggleText.html(t.translate("map.mapToggle"));
            var r = t.translate("map.dragons");
            for (var i = 0; i < r.length; i++) n.addMarker(r[i], "dragon", i)
        },
        setLocationMarkers: function(e) {
            var n = this,
                r = 0;
            e && (r = 1300), this.$toggleText.html(t.translate("map.dragonToggle"));
            var i = t.translate("map.locations");
            for (var s = 0; s < i.length; s++) n.addMarker(i[s], "location", s, r)
        },
        addMarker: function(e, t, n, r) {
            var i = this,
                s;
            if (!r) var r = 0;
            var o = this.getMarkerStyle();
            typeof e.useAltMarker == "boolean" && e.useAltMarker && (t === "location" ? o.image.url = "images/views/map/location-marker-light.png" : o.image.url = "images/views/map/dragon-marker-light.png"), s = setTimeout(function() {
                var r = new google.maps.LatLng(e.lat, e.long),
                    s = new google.maps.Marker({
                        position: r,
                        map: i.map,
                        icon: o.image,
                ...
                i.addMarkerClickEvent(t, s, e), i.markers.push(s)
            }, n * 100 + r), this.markerTimeouts.push(s)
        },
        addMarkerClickEvent: function(e, t, n) {
            var r = this;
            google.maps.event.addListener(t, "click", function() {
                e === "dragon" ? r.onDragonSelected(n) : r.onLocationSelected(n)
            })
        }
    });
    return f
    ...
    function(e) {
        typeof define == "function" && define.amd && define.amd.jQuery ? define("touchSwipe", ["jquery"], e) : e(jQuery)
    }(function(e) {
        function L(t) {
        ...
        function A(d, k) {
            function ot(t) {
                if (Rt()) return;
                if (e(t.target).closest(k.excludedElements, J).length > 0) return;
                var n = t.originalEvent ? t.originalEvent : t,
                    r, i = x ? n.touches[0] : n;
                K = b, x ? Q = n.touches.length : t.preventDefault(), H = 0, F = null, V = null, I = 0, R = 0, U = 0, W = 1, X = 0, G = Vt(), $ = Kt(), It();
                if (!x || Q === k.fingers || k.fingers === g || Et()) {
                    zt(0, i), Y = sn(), Q == 2 && (zt(1, n.touches[1]), R = U = Yt(G[0].start, G[1].start));
                    if (k.swipeStatus || k.pinchStatus) r = pt(n, K)
                } else r = !1;
                return r === !1 ? (K = S, pt(n, K), r) : (k.hold && (it = setTimeout(e.proxy(function() {
                    J.trigger("hold", [n.target]), k.hold && (r = k.hold.call(J, n, n.target))
                }, this), k.longTapThreshold)), Ut(!0), null)
            }

            function ut(e) {
                var t = e.originalEvent ? e.originalEvent : e;
                if (K === E || K === S || qt()) return;
                var n, r = x ? t.touches[0] : t,
                    i = Wt(r);
                Z = sn(), x && (Q = t.touches.length), k.hold && clearTimeout(it), K = w, Q == 2 && (R == 0 ? (zt(1, t.touches[1]), R = U = Yt(G[0].start, G[1].start)) : (Wt(t.touches[1]), U = Yt(G[0].end, G[1].end), V = en(G[0].end, G[1].end)), W = Zt(R, U), X = Math.abs(R - U));
                if (Q === k.fingers || k.fingers === g || !x || Et()) {
                    F = rn(i.start, i.end), bt(e, F), H = tn(i.start, i.end), I = Gt(), $t(F, H);
                    if (k.swipeStatus || k.pinchStatus) n = pt(t, K);
                    if (!k.triggerOnTouchEnd || k.triggerOnTouchLeave) {
                        var s = !0;
                        if (k.triggerOnTouchLeave) {
                            var o = on(this);
                            s = un(i.end, o)
                        }!k.triggerOnTouchEnd && s ? K = ht(w) : k.triggerOnTouchLeave && !s && (K = ht(E)), (K == S || K == E) && pt(t, K)
                    }
                } else K = S, pt(t, K);
                n === !1 && (K = S, pt(t, K))
            }
            ...
            function at(e) {
                ...
                return x && t.touches.length > 0 ? (Ft(), !0) : (qt() && (Q = tt), Z = sn(), I = Gt(), mt() || !vt() ? (K = S, pt(t, K)) : k.triggerOnTouchEnd || k.triggerOnTouchEnd == 0 && K === w ? (e.preventDefault(), K = E, pt(t, K)) : !k.triggerOnTouchEnd && Lt() ? (K = E, dt(t, K, c)) : K === w && (K = S, pt(t, K)), Ut(!1), null)
            }

            function ft() {
                Q = 0, Z = 0, Y = 0, R = 0, U = 0, W = 1, It(), Ut(!1)
            }

            function lt(e) {
                var t = e.originalEvent;
                k.triggerOnTouchLeave && (K = ht(E), pt(t, K))
            }

            function ct() {
                J.unbind(A, ot), J.unbind(P, ft), J.unbind(O, ut), J.unbind(M, at), _ && J.unbind(_, lt), Ut(!1)
            }
            ...
            function ht(e) {
                var t = e,
                    ...
                    r = vt(),
                    i = mt();
                return !n || i ? t = S : r && e == w && (!k.triggerOnTouchEnd || k.triggerOnTouchLeave) ? t = E : !r && e == E && k.triggerOnTouchLeave && (t = S), t
            }

            function pt(e, t) {
                var n = undefined;
                return Nt() || Tt() ? n = dt(e, t, f) : (St() || Et()) && n !== !1 && (n = dt(e, t, l)), Bt() && n !== !1 ? n = dt(e, t, h) : jt() && n !== !1 ? n = dt(e, t, p) : Ht() && n !== !1 && (n = dt(e, t, c)), t === S && ft(e), t === E && (x ? e.touches.length == 0 && ft(e) : ft(e)), n
            }

            function dt(u, a, d) {
                var v = undefined;
                if (d == f) {
                    J.trigger("swipeStatus", [a, F || null, H || 0, I || 0, Q, G]);
                    if (k.swipeStatus) {
                        v = k.swipeStatus.call(J, u, a, F || null, H || 0, I || 0, Q, G);
                        if (v === !1) return !1
                    }
                    if (a == E && xt()) {
                        J.trigger("swipe", [F, H, I, Q, G]);
                        if (k.swipe) {
                            v = k.swipe.call(J, u, F, H, I, Q, G);
                            if (v === !1) return !1
                        }
                        switch (F) {
                            case t:
                                J.trigger("swipeLeft", [F, H, I, Q, G]), k.swipeLeft && (v = k.swipeLeft.call(J, u, F, H, I, Q, G));
                                break;
                            case n:
                                J.trigger("swipeRight", [F, H, I, Q, G]), k.swipeRight && (v = k.swipeRight.call(J, u, F, H, I, Q, G));
                                break;
                            case r:
                                J.trigger("swipeUp", [F, H, I, Q, G]), k.swipeUp && (v = k.swipeUp.call(J, u, F, H, I, Q, G));
                                break;
                            case i:
                                J.trigger("swipeDown", [F, H, I, Q, G]), k.swipeDown && (v = k.swipeDown.call(J, u, F, H, I, Q, G))
                        }
                    }
                }
                if (d == l) {
                    J.trigger("pinchStatus", [a, V || null, X || 0, I || 0, Q, W, G]);
                    if (k.pinchStatus) {
                        v = k.pinchStatus.call(J, u, a, V || null, X || 0, I || 0, Q, W, G);
                        if (v === !1) return !1
                    }
                    if (a == E && wt()) switch (V) {
                        case s:
                            J.trigger("pinchIn", [V || null, X || 0, I || 0, Q, W, G]), k.pinchIn && (v = k.pinchIn.call(J, u, V || null, X || 0, I || 0, Q, W, G));
                            break;
                        case o:
                            J.trigger("pinchOut", [V || null, X || 0, I || 0, Q, W, G]), k.pinchOut && (v = k.pinchOut.call(J, u, V || null, X || 0, I || 0, Q, W, G))
                    }
                }
                if (d == c) {
                    if (a === S || a === E) clearTimeout(rt), clearTimeout(it), At() && !_t() ? (nt = sn(), rt = setTimeout(e.proxy(function() {
                        nt = null, J.trigger("tap", [u.target]), k.tap && (v = k.tap.call(J, u, u.target))
                    }, this), k.doubleTapThreshold)) : (nt = null, J.trigger("tap", [u.target]), k.tap && (v = k.tap.call(J, u, u.target)))
                } else if (d == h) {
                    if (a === S || a === E) clearTimeout(rt), nt = null, J.trigger("doubletap", [u.target]), k.doubleTap && (v = k.doubleTap.call(J, u, u.target))
                } else d == p && (a === S || a === E) && (clearTimeout(rt), nt = null, J.trigger("longtap", [u.target]), k.longTap && (v = k.longTap.call(J, u, u.target)));
                return v
            }

            function vt() {
                var e = !0;
                return k.threshold !== null && (e = H >= k.threshold), e
            }

            function mt() {
                var e = !1;
                return k.cancelThreshold !== null && F !== null && (e = Jt(F) - H >= k.cancelThreshold), e
            }

            function gt() {
                return k.pinchThreshold !== null ? X >= k.pinchThreshold : !0
            }

            function yt() {
                var e;
                return k.maxTimeThreshold ? I >= k.maxTimeThreshold ? e = !1 : e = !0 : e = !0, e
            }

            function bt(e, s) {
                if (k.allowPageScroll === u || Et()) e.preventDefault();
                else {
                    var o = k.allowPageScroll === a;
                    switch (s) {
                        case t:
                            (k.swipeLeft && o || !o && k.allowPageScroll != v) && e.preventDefault();
                            break;
                        case n:
                            (k.swipeRight && o || !o && k.allowPageScroll != v) && e.preventDefault();
                            break;
                        case r:
                            (k.swipeUp && o || !o && k.allowPageScroll != m) && e.preventDefault();
                            break;
                        case i:
                            (k.swipeDown && o || !o && k.allowPageScroll != m) && e.preventDefault()
                    }
                }
            }
            ...
            function Ct() {
                return Q === k.fingers || k.fingers === g || !x
            }
            ...
            function Mt() {
                if (nt == null) return !1;
                var e = sn();
                return At() && e - nt <= k.doubleTapThreshold
            }
            ...
            function Dt() {
                return (Q === 1 || !x) && (isNaN(H) || H < k.threshold)
            }

            function Pt() {
                return I > k.longTapThreshold && H < y
            }
            ...
            function Ft() {
                et = sn(), tt = event.touches.length + 1
            }
            ...
            function qt() {
                ...
                if (et) {
                    var t = sn() - et;
                    t <= k.fingerReleaseThreshold && (e = !0)
                }
                return e
            }

            function Rt() {
                return J.data(C + "_intouch") === !0
            }

            function Ut(e) {
                e === !0 ? (J.bind(O, ut), J.bind(M, at), _ && J.bind(_, lt)) : (J.unbind(O, ut, !1), J.unbind(M, at, !1), _ && J.unbind(_, lt, !1)), J.data(C + "_intouch", e === !0)
            }

            function zt(e, t) {
                var n = t.identifier !== undefined ? t.identifier : 0;
                return G[e].identifier = n, G[e].start.x = G[e].end.x = t.pageX || t.clientX, G[e].start.y = G[e].end.y = t.pageY || t.clientY, G[e]
            }
            ...
            function Xt(e) {
                for (var t = 0; t < G.length; t++)
                    if (G[t].identifier == e) return G[t]
            }

            function Vt() {
                var e = [];
                for (var t = 0; t <= 5; t++) e.push({
                    start: {
                        x: 0,
                        y: 0
                    },
            ...
            function $t(e, t) {
                t = Math.max(t, Jt(e)), $[e].distance = t
            }
            ...
            function Kt() {
                var e = {};
                return e[t] = Qt(t), e[n] = Qt(n), e[r] = Qt(r), e[i] = Qt(i), e
            }
            ...
            var L = x || N || !k.fallbackToMouseEvents,
                ...
                O = L ? N ? T ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
                M = L ? N ? T ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup",
                _ = L ? null : "mouseleave",
                P = N ? T ? "MSPointerCancel" : "pointercancel" : "touchcancel",
                H = 0,
                F = null,
                I = 0,
                R = 0,
                ...
                it = null;
            try {
                J.bind(A, ot), J.bind(P, ft)
            } catch (st) {
                e.error("events not supported " + A + "," + P + " on jQuery.swipe")
            }
            this.enable = function() {
                return J.bind(A, ot), J.bind(P, ft), J
            }, this.disable = function() {
                return ct(), J
            }, this.destroy = function() {
                return ct(), J.data(C, null), J
            }, this.option = function(t, n) {
                if (k[t] !== undefined) {
                    if (n === undefined) return k[t];
                    k[t] = n
        ...
        e.fn.swipe = function(t) {
            ...
            } else if (!r && (typeof t == "object" || !t)) return L.apply(this, arguments);
            return n
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    }("undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window, "TweenMax"), define("tweenmax", function(e) {
    return function() {
        var t, n;
        return t || e.TweenMax
    }
}(this)), define("lib/gozu/carousel/CarouselEvents", [], function() {
    var e = {
    ...
    return e
}), define("lib/gozu/carousel/CarouselView", ["backbone", "touchSwipe", "tweenmax", "lib/gozu/carousel/CarouselEvents"], function(e, t, n, r) {
    var i = e.View.extend({
        items: [],
        total: 0,
        youtubeAPI: !1,
        index: 0,
        initialize: function(e) {
            _.bindAll(this, "onKey", "onSwipe", "onTap"), this.data = e.data, this.addListeners(), this.initHTML(), this.initCSS()
        },
        initHTML: function() {
            this.items = this.$el.find(".item"), this.items.wrapAll('<div class="mask"><div class="wrapper"></div></div>'), this.mask = this.$el.find(".mask"), this.wrapper = this.$el.find(".wrapper"), this.checkForYoutubeVideo(), this.data.infinite == 1 && (this.wrapper.append(this.items.clone()), this.items = this.$el.find(".item")), this.total = this.items.length
        },
        initCSS: function() {
            this.data.fullscreen ? (this.items.css({
                ...
                width: this.data.width * this.total
            }), this.items.css({
                width: this.data.width
            }))
        },
        addListeners: function() {
            this.data.keyboard == 1 && $(window).on("keydown", this.onKey), this.$el.swipe({
                allowPageScroll: "vertical",
                tap: this.onTap,
                swipe: this.onSwipe
            })
        },
        checkForYoutubeVideo: function() {
            _.each(this.items, function(e) {
                if ($(e).find("img").data("src").indexOf("images/") < 0) {
                    var t = $(e).find("img").data("src");
                    $(e).addClass("youtube").data("youtubeid", t)
                }
            })
        },
        animate: function(e, t) {
            this.items.eq(this.index % (this.total / 2)).is(".youtube") && this.items.find(".iframe-container").empty(), this.index = e;
            if (this.items.eq(this.index % (this.total / 2)).is(".youtube")) {
                var r = this.items.eq(this.index % (this.total / 2)).data("youtubeid");
                this.items.eq(this.index).empty().append('<div class="iframe-container"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/' + r + '?rel=0&showinfo=0&autohide=1&iv_load_policy=1&wmode=transparent" frameborder="0" allowfullscreen></iframe></div>')
            } else this.items.eq(this.index).find("img").attr("src", this.items.eq(this.index).find("img").data("src"));
            t ? n.to(this.wrapper, .5, {
                x: -(this.mask.width() / this.data.step) * e,
                ease: Expo.easeOut
            }) : n.set(this.wrapper, {
                x: -(this.mask.width() / this.data.step) * e,
                ease: Expo.easeOut
        ...
        onKey: function(e) {
            e.keyCode == 39 ? this.trigger(r.NEXT_ITEM) : e.keyCode == 37 && this.trigger(r.PREVIOUS_ITEM)
        },
        onSwipe: function(e, t) {
            t == "left" ? this.trigger(r.NEXT_ITEM) : t == "right" && this.trigger(r.PREVIOUS_ITEM)
        },
        onTap: function(e) {
            var t = $(e.target).parents(".item");
            this.trigger(r.ITEM_CLICK, {
                item: t,
                id: t.index()
            })
        },
        resize: function(e, t) {
            ...
            this.wrapper.css({
                ...
                x: -(this.mask.width() / this.data.step) * t,
                ease: Expo.easeOut
            })
        },
        clear: function() {
            this.items.find(".iframe-container").empty()
        },
        destroy: function() {
            this.clear(), $(window).off("keydown", this.onKey)
        }
    });
    return i
}), define("lib/gozu/carousel/arrows/CarouselArrowsView", ["backbone", "lib/gozu/carousel/CarouselEvents"], function(e, t) {
    "use strict";
    var n = e.View.extend({
        controller: null,
        left: null,
        right: null,
        initialize: function(e) {
            _.bindAll(this, "onMouseOver", "previousItem", "nextItem"), this.carousel = e, this.initHTML(), this.addListeners()
        },
        initHTML: function() {
            this.carousel.append('<div class="arrow left"></div><div class="arrow right"></div>'), this.left = this.carousel.find(".left"), this.right = this.carousel.find(".right")
        },
        addListeners: function() {
            this.left.on("click", this.previousItem), this.right.on("click", this.nextItem), this.left.on("mouseover", this.onMouseOver), this.left.on("mouseout", this.onMouseOut), this.right.on("mouseover", this.onMouseOver), this.right.on("mouseout", this.onMouseOut)
        },
        update: function(e) {
            e.left ? this.left.css({
                display: "block"
            }) : this.left.css({
                display: "none"
            }), e.right ? this.right.css({
                display: "block"
            }) : this.right.css({
                display: "none"
            })
        ...
        previousItem: function(e) {
            this.trigger(t.PREVIOUS_ITEM)
        },
        nextItem: function(e) {
            this.trigger(t.NEXT_ITEM)
        },
        ...
        destroy: function() {
            this.left.off("click", this.previousItem), this.right.off("click", this.nextItem), this.left.off("mouseover", this.onMouseOver), this.right.off("mouseover", this.onMouseOver)
        }
    });
    return n
}), define("lib/gozu/carousel/CarouselController", ["touchSwipe", "tweenmax", "lib/gozu/carousel/CarouselEvents", "lib/gozu/carousel/CarouselView", "lib/gozu/carousel/arrows/CarouselArrowsView"], function(e, t, n, r, i) {
    var s = Backbone.View.extend({
        data: null,
        currentIndex: 0,
        active: !0,
        initialize: function(e) {
            this.data = e, _.bindAll(this, "previousItem", "nextItem", "onComplete"), this.initParams(), this.initView(), this.addListeners()
        },
        initView: function() {
            this.view = new r({
                el: this.data.el,
                data: this.data
            }), this.data.step >= this.view.total && (this.active = !1), this.data.arrows && this.active && (this.arrows = new i(this.data.el), this.arrows.on(n.NEXT_ITEM, this.nextItem), this.arrows.on(n.PREVIOUS_ITEM, this.previousItem), !this.data.infinite && this.currentIndex == 0 && this.update({
                left: !1,
                right: !0
            })), this.view.animate(this.currentIndex)
        },
        initParams: function() {
            this.data.visibleItems == undefined ? this.data.visibleItems = 0 : this.data.visibleItems--, this.data.startIndex == undefined ? this.currentIndex = 0 : this.currentIndex = this.data.startIndex
        },
        addListeners: function() {
            this.active && (this.view.on(n.NEXT_ITEM, this.nextItem), this.view.on(n.PREVIOUS_ITEM, this.previousItem))
        },
        nextItem: function(e) {
            if (!this.data.infinite) {
                if (this.currentIndex == this.view.total - 1) return;
                this.view.total - this.currentIndex - this.data.step <= this.data.step ? (this.currentIndex += this.view.total - this.currentIndex - this.data.step, this.update({
                    left: !0,
                    right: !1
                })) : (this.currentIndex += this.data.step, this.update({
                    left: !0,
                    right: !0
                }))
            } else this.view.total - this.currentIndex - this.data.step < this.data.step ? (this.currentIndex -= this.view.total / 2, this.view.animate(this.currentIndex, !1), this.currentIndex += this.data.step) : this.currentIndex += this.data.step;
            this.view.animate(this.currentIndex, !0)
        },
        previousItem: function() {
            if (!this.data.infinite) {
                if (this.currentIndex == 0) return;
                this.currentIndex <= this.data.step ? (this.currentIndex -= this.currentIndex, this.update({
                    left: !1,
                    right: !0
                })) : (this.currentIndex -= this.data.step, this.update({
                    left: !0,
            ...
            } else this.currentIndex - this.data.step < 0 ? (this.currentIndex += this.view.total / 2, this.view.animate(this.currentIndex, !1), this.currentIndex -= this.data.step) : this.currentIndex -= this.data.step;
            this.view.animate(this.currentIndex, !0)
        },
        update: function(e) {
            this.currentIndex = e, this.view.animate(this.currentIndex, !0)
        },
        onComplete: function() {
            this.isTweening = !1
        },
        onTap: function() {
            this.trigger(n.ITEM_CLICK)
        },
        destroy: function() {
            this.view.off(n.NEXT_ITEM, this.nextItem), this.view.off(n.PREVIOUS_ITEM, this.previousItem), this.data.arrows && typeof this.arrows != "undefined" && (this.arrows.off(n.NEXT_ITEM, this.nextItem), this.arrows.off(n.PREVIOUS_ITEM, this.previousItem)), this.currentIndex = 0, this.view.destroy()
        },
        show: function() {
        ...
        clear: function() {
            this.currentIndex = 0, this.view.clear(), this.view.animate(this.currentIndex, !1)
        },
        resize: function(e) {
            this.view.resize(e, this.currentIndex)
        }
    });
    return s
}), define("views/detail/BaseDetailView", ["backbone", "App", "lib/gozu/carousel/CarouselController", "lib/gozu/carousel/CarouselEvents"], function(e, t, n, r) {
    var i = e.View.extend({
        model: null,
        slug: null,
        initialize: function() {
            this.initPageChangeEvent(), this.initButtons()
        },
        initPageChangeEvent: function() {
            window.vent.on("PageChange", _.bind(this.onPageChange, this)), window.vent.on("Map:InfoView:ThumbnailSelected", _.bind(this.onThumbnailSelected, this))
        },
        _onPageChange: function(e) {
            var t = this;
            e.id === this.pageId ? (this.$el.hasClass("disabled") ? (this.$el.removeClass("disabled"), setTimeout(function() {
                t.$el.hasClass("active") || t.$el.addClass("active")
            }, 20)) : this.$el.hasClass("active") || this.$el.addClass("active"), this.render()) : (this.$el.removeClass("active"), this.$el.hasClass("disabled") || setTimeout(function() {
                t.$el.addClass("disabled")
            }, 600), this.clear())
        },
        initButtons: function() {
            this.close = this.$el.find(".close span"), this.aboutBtn = this.$el.find("nav .about"), this.galleryBtn = this.$el.find("nav .gallery"), this.aboutBtn.on("click", _.bind(this.onNavClick, this)), this.galleryBtn.on("click", _.bind(this.onNavClick, this))
        },
        reset: function() {
            this.$content.find(".about-section").addClass("selected"), this.$content.find(".gallery-section").removeClass("selected"), this.carousel && (this.paginationItems.removeClass("selected"), this.paginationItems.eq(0).addClass("selected")), this.aboutBtn.addClass("selected"), this.galleryBtn.removeClass("selected")
        },
        showTitle: function() {
            var e = this.$el.find("h1"),
                t = "";
            _.each(e.html(), function(e) {
                t += "<span>" + e + "</span>"
            }), e.html(t)
        },
        updateGlobalCopies: function() {
            this.close.text(t.translate("detailCopy").backToMap), this.$el.find(".gallery-section .close span").text(t.translate("detailCopy").backToMap), this.aboutBtn.text(t.translate("detailCopy").about), this.galleryBtn.text(t.translate("detailCopy").gallery)
        },
        initCarousel: function() {
            this.paginationItems = this.$el.find(".pagination li"), this.carousel = new n({
            ...
            if (this.$el.find(".carousel .item").length <= 2) {
                typeof this.carousel.arrows != "undefined" && this.carousel.arrows.hide(), this.paginationItems.hide();
                return
            }
            this.carousel.view.on(r.NEXT_ITEM, _.bind(this.onUpdate, this)), this.carousel.view.on(r.PREVIOUS_ITEM, _.bind(this.onUpdate, this)), typeof this.carousel.arrows != "undefined" && (this.carousel.arrows.on(r.NEXT_ITEM, _.bind(this.onUpdate, this)), this.carousel.arrows.on(r.PREVIOUS_ITEM, _.bind(this.onUpdate, this))), this.paginationItems.eq(0).addClass("selected"), this.paginationItems.on("click", _.bind(this.onPaginationItemClick, this))
        },
        onNavClick: function(e) {
            if ($(e.currentTarget).is(".selected")) return;
            this.$el.find("button").removeClass("selected"), $(e.currentTarget).addClass("selected"), $(e.currentTarget).is(".about") ? (this.$content.find(".about-section").addClass("selected"), this.$content.find(".gallery-section").removeClass("selected"), this.carousel && (this.carousel.clear(), this.paginationItems.removeClass("selected"), this.paginationItems.eq(0).addClass("selected")), t.trackEvent("detailView", "aboutClicked")) : (this.$content.find(".about-section").removeClass("selected"), this.$content.find(".gallery-section").addClass("selected"), t.trackEvent("detailView", "galleryClicked"))
        },
        onUpdate: function() {
            this.paginationItems.removeClass("selected"), this.paginationItems.eq(this.carousel.currentIndex % (this.carousel.view.total / 2)).addClass("selected")
        },
        onPaginationItemClick: function(e) {
            this.paginationItems.removeClass("selected"), $(e.currentTarget).addClass("selected"), this.carousel.update($(e.currentTarget).index())
        },
        onThumbnailSelected: function() {
            this.$el.find("button").removeClass("selected"), this.$el.find("button.gallery").addClass("selected"), this.$content.find(".about-section").removeClass("selected"), this.$content.find(".gallery-section").addClass("selected")
        },
        resize: function() {
            if ($(window).width() < 960) {
                this.$el.find(".content").css({
                    ...
                    width: "auto"
                }), this.$el.find(".image-container").css({
                    width: "100%"
                });
                return
            }
            var e = $(window).width() - this.$el.find("nav").outerWidth(!0, !0),
                t = this.$content.find(".about-section").height(),
                n = .5625,
                r = e / 2 * n;
            t < r && (t = r), t += this.$el.find(".content header").height(), this.$el.find(".content").css({
                width: e,
                height: t,
                left: this.$el.find("nav").outerWidth(!0, !0)
            }), this.$el.find("footer").css({
                left: this.$el.find("nav").outerWidth(!0, !0)
            }), this.$el.find(".image").css({
                width: "100%"
            }), this.$el.find(".image-container").css({
                width: ($(window).width() - this.$el.find("nav").outerWidth(!0, !0)) / 2
            }), this.carousel && this.carousel.resize($(window).width() / 2 - this.$el.find("nav").outerWidth(!0, !0))
        },
        getModelByPath: function(e) {
            this.getSlug();
            var n = t.translate(this.pageId + "." + e)
        },
        getSlug: function() {
            var e = window.location.hash,
                t = e.split("/"),
                n = t[t.length - 1];
            return this.slug = n, n
        },
        clear: function() {
    ...
    return i
}), define("text!templates/detail/LocationDetailView.hbs", [], function() {
    return '<div class="mobile image-container"><img class="image"/></div>\n<header class="m-pad">\n	<h1>{{name}}</h1>\n	<hr/>\n</header>\n<div class="sections-container">\n<section class="about-section selected m-pad">		\n	<p class="synopsis">{{{info.synopsis}}}</p>\n</section>\n<section class="gallery-section">\n	<div class="carousel">\n	{{#each photos}}		\n		<div class="item">\n			<img data-src="{{this}}"/>\n		</div>\n	{{/each}}\n	</div>\n	<ul class="pagination">\n	{{#each photos}}		\n		<li></li>\n	{{/each}}\n	</ul>\n	<button class="button shadow close"><span></span></button>\n</section>\n</div>'
}), define("views/detail/LocationDetailView", ["App", "backbone", "handlebars", "views/detail/BaseDetailView", "text!templates/detail/LocationDetailView.hbs"], function(e, t, n, r, i) {
    var s = r.extend({
        template: null,
        pageId: "location",
        el: "#locationDetail",
        ...
        $content: null,
        events: {
            "click button.close": "onClickBttnClose"
        },
        initialize: function() {
            r.prototype.initialize.apply(this), this.$content = this.$el.find(".content"), this.template = n.compile(i)
        },
        onClickBttnClose: function() {
            e.navigateTo("/map")
        },
        onPageChange: function(e) {
            r.prototype._onPageChange.apply(this, arguments), e.id == "location" ? window.vent.on("App:onResize", _.bind(this.onResize, this)) : window.vent.off("App:onResize", _.bind(this.onResize, this))
        },
        render: function() {
            var t = this.getSlug();
            this.model = e.translate("locations." + t), this.$content.html(this.template(this.model)), this.reset(), this.showTitle(), this.initCarousel(), this.updateGlobalCopies(), this.model.info.imageName == undefined && (this.model.info.imageName = "default"), this.model.info.quote == "" && this.$el.find("blockquote").hide(), this.$el.find(".image").attr("src", "images/views/detail/locations/" + this.model.info.imageName + ".png"), this.$content.find(".details span").html(e.translate("detailCopy").location + ": "), this.onResize();
            var n = this;
            setTimeout(function() {
                n.onResize()
            }, 500)
    ...
    return s
}), define("text!templates/detail/DragonDetailView.hbs", [], function() {
    return '<div class="mobile image-container"><img class="image"/></div>\n<header class="m-pad">\n	<h1>{{name}}</h1>\n	<div class="details">\n		<span class="class">{{copy.class}}</span>{{info.class}}\n	</div>\n	<hr/>\n</header>\n<div class="sections-container">\n<section class="about-section m-pad selected">	\n	<p class="description">{{info.description}}</blockquote>\n	<p class="synopsis">{{{info.synopsis}}}</p>\n</section>\n<section class="gallery-section">\n	<div class="carousel">\n	{{#each photos}}		\n		<div class="item">\n			<img data-src="{{this}}"/>\n		</div>\n	{{/each}}\n	</div>\n	<ul class="pagination">\n	{{#each photos}}		\n		<li></li>\n	{{/each}}\n	</ul>\n	<button class="button shadow close"><span></span></button>\n</section>\n</div>'
}), define("views/detail/DragonDetailView", ["App", "backbone", "handlebars", "views/detail/BaseDetailView", "text!templates/detail/DragonDetailView.hbs"], function(e, t, n, r, i) {
    var s = r.extend({
        template: null,
        pageId: "dragon",
        el: "#dragonDetail",
        ...
        initialize: function() {
            r.prototype.initialize.apply(this), this.$content = this.$el.find(".content"), this.template = n.compile(i), this.$close = this.$el.find(".close span")
        },
        onClickBttnClose: function() {
            e.navigateTo("/map")
        },
        onPageChange: function(e) {
            r.prototype._onPageChange.apply(this, arguments), e.id == "dragon" ? window.vent.on("App:onResize", _.bind(this.onResize, this)) : window.vent.off("App:onResize", _.bind(this.onResize, this))
        },
        render: function() {
            var t = this.getSlug();
            this.model = e.translate("dragons." + t), this.$content.html(this.template(this.model)), this.reset(), this.showTitle(), this.initCarousel(), this.updateGlobalCopies(), this.model.info.imageName == undefined && (this.model.info.imageName = "default"), this.$el.find(".mobile .image").attr("src", "images/views/detail/dragons/" + this.model.info.imageName + "1x.png"), this.$el.find(".desktop .image").attr("src", "images/views/detail/dragons/" + this.model.info.imageName + ".png"), this.$content.find(".class").html(e.translate("detailCopy").class + ": "), this.onResize()
        },
        onResize: function() {
            this.resize()
        }
    ...
    return s
}), define("text!templates/exit/ExitView.hbs", [], function() {
    return '<div class="copy">\n	<img class="dreamworks" src="images/views/index/dreamworks.png"/>\n    <img class="logo"/>\n    <hr/>\n    <p>{{{description}}}</p>\n    <div class="button-anim"><button class="button shadow back"><span>{{goBack}}</span></button></div>\n    <div class="button-anim"><button class="button shadow continue"><span>{{continue}}</span></button></div>\n</div>\n<div class="image-container">\n	<img class="image" src="images/views/exit/ruf-tuf-dragon.png"/>\n</div>'
}), define("views/exit/ExitView", ["App", "backbone", "handlebars", "text!templates/exit/ExitView.hbs"], function(e, t, n, r) {
    var i = t.View.extend({
        linkURL: "",
        el: "#exit",
        initialize: function() {
            this.$contentContainer = this.$el.find(".content"), this.initEvents()
        },
        initEvents: function() {
            window.vent.on("PageChange", _.bind(this.onPageChange, this))
        },
        onPageChange: function(e) {
            var t = this;
            e.id === "exit" ? (this.$el.hasClass("disabled") ? (this.$el.removeClass("disabled"), setTimeout(function() {
                t.$el.hasClass("active") || t.$el.addClass("active")
            }, 20)) : this.$el.hasClass("active") || this.$el.addClass("active"), this.render()) : (this.$el.removeClass("active"), this.$el.hasClass("disabled") || setTimeout(function() {
                t.$el.addClass("disabled")
            }, 400)), e.id == "exit" ? window.vent.on("App:onResize", _.bind(this.onResize, this)) : window.vent.off("App:onResize", _.bind(this.onResize, this))
        },
        render: function() {
            var t = e.translate("exit");
            hbs = n.compile(r), this.$contentContainer.html(hbs(t)), this.$el.find(".logo").attr("src", e.translate("index").titleGraphic), this.$el.find(".logo").attr("alt", e.translate("index").titleGraphicAlt), this.$el.find(".back").on("click", _.bind(this.onBackClick, this)), this.$el.find(".continue").on("click", _.bind(this.onContinueClick, this)), this.onResize()
        },
        onBackClick: function() {
            window.history.back()
        },
        onContinueClick: function() {
            this.linkURL != "" && window.open(this.linkURL, "_blank")
        },
        onResize: function() {
            $(window).width() < 960 ? (this.$contentContainer.prepend(this.$el.find(".image-container")), this.$el.find(".image").attr("src", "images/views/exit/ruf-tuf-dragon1x.png")) : (this.$contentContainer.append(this.$el.find(".image-container")), this.$el.find(".image").attr("src", "images/views/exit/ruf-tuf-dragon.png"))
        }
    });
    return i
}), define("views/common/FooterView", ["App", "backbone", "handlebars", "utils/LocalizationHelper", "text!templates/common/Footer.hbs"], function(e, t, n, r, i) {
    var s = t.View.extend({
        el: "footer",
        events: {
            "change .localeSelect": "onLocaleSelectChange"
        ...
        initEvents: function() {
            window.vent.on("PageChange", _.bind(this.onPageChange, this)), window.vent.on("Locale:change", _.bind(this.onLocaleChange, this))
        },
        onPageChange: function(e) {
            window.vent.off("PageChange", _.bind(this.onPageChange, this)), this.render()
        },
        onLocaleChange: function() {
            this.render()
        },
        render: function() {
            var t = e.translate("legal");
            hbs = n.compile(i), t.ratingsVisible = !1, t.ratingsImage.length > 0 && (t.ratingsVisible = !0), this.$el.html(hbs(t));
            if (!window.mobile) {
                $("#index footer .dreamworks").attr("src", "images/views/common/footer-dreamworks-white.png");
                var r = $("#index footer .ratingImage");
                r.attr("src", r.attr("data-light"))
            }
        },
        getSlug: function() {
            var e = window.location.hash,
    ...
    return s
}), define("AppRouter", ["backbone", "views/index/IndexView", "views/map/MapView", "views/detail/LocationDetailView", "views/detail/DragonDetailView", "views/exit/ExitView", "views/common/FooterView", "utils/LocalizationHelper"], function(e, t, n, r, i, s, o, u) {
    var a = e.Router.extend({
        indexView: null,
        mapView: null,
        hasInitted: !1,
        currView: null,
        currViewId: null,
        isInitialPageDispatch: !0,
        routes: {
            "": "index",
            map: "map",
            intro: "intro",
            ...
            "dragon/:slug": "dragon",
            exit: "exit",
            ":locale": "localizedIndex",
            ":locale/intro": "localizedIntro",
            ":locale/map": "localizedMap",
            ":locale/location/:slug": "localizedLocation",
            ":locale/dragon/:slug": "localizedDragon"
        },
        initialize: function() {
            this.indexView = new t, this.mapView = new n, this.locationDetailView = new r, this.dragonDetailView = new i, this.exitView = new s, this.footer = new o
        },
        index: function() {
            this.setCurrView(this.indexView, "index")
        },
        dragon: function(e) {
            this.setCurrView(this.dragonDetailView, "dragon")
        },
        location: function(e) {
            this.setCurrView(this.locationDetailView, "location")
        },
        intro: function() {
            this.setCurrView(this.indexView, "intro")
        },
        exit: function() {
            this.setCurrView(this.indexView, "exit")
        },
        map: function() {
            this.setCurrView(this.mapView, "map")
        },
        localizedIndex: function(e) {
            this.hasInitted && u.changeLocale(e, !0), this.index()
        },
        localizedIntro: function(e) {
            this.hasInitted && u.changeLocale(e, !0), this.intro()
        },
        localizedLocation: function(e, t) {
            this.hasInitted && u.changeLocale(e, !0), this.location(t)
        },
        localizedMap: function(e) {
            this.hasInitted && u.changeLocale(e, !0), this.map()
        },
        localizedDragon: function(e, t) {
            this.hasInitted && u.changeLocale(e, !0), this.dragon(t)
        },
        setCurrView: function(e, t) {
            if (t === this.currViewId) return;
            this.currView !== null && typeof this.currView.onPageLeave == "function" && this.currView.onPageLeave(), this.currView = e, this.currViewId = t, window.vent.trigger("PageChange", {
                id: this.currViewId,
                isInitialChange: this.isInitialPageDispatch
            }), this.isInitialPageDispatch = !1
        }
    });
    return new a
});